...
def get_emotion():
    ...
    # driver = webdriver.Firefox(firefox_options=firefox_options,executable_path='C:\Users\Administrator\sweet\geckodriver\geckodriver.exe')
    # driver = webdriver.Firefox(firefox_options=firefox_options,executable_path='/root/geckodriver')
    chrome_options = webdriver.ChromeOptions()
    # chrome_options.add_argument('--headless')
    # chrome_options.add_argument('--disable-gpu')
    # chrome_options.add_argument("--no-sandbox")
    driver = webdriver.Chrome(chrome_options=chrome_options,executable_path='/Users/anshi/Desktop/resource/anshi/chromedriver')
    ...
    print(driver.find_element_by_id('u').get_attribute('value'))
    print(driver.find_element_by_id('u').get_attribute('value'))
    ...
    script = 'document.getElementById("login_button").click()'
    ...
    tem = WebDriverWait(driver, 120, 1).until_not(lambda x: x.find_element_by_id("login_button").is_displayed())
    # 登录按钮消失则登录成功 err_m
    # tem = WebDriverWait(driver, 10, 1).until_not(lambda x: x.find_element_by_id("login_button").is_displayed())
    print('login!')
    time.sleep(10)
