...
public final class Constants {
    ...
    // 可牛
    public static final Integer ADD_SCORE_BY_SHARE = 10;//每次分享所得积分
    public static final Integer ADD_SCORE_TYPE_SHARE = 1;//积分类型 分享得到
    public static final Integer ADD_SCORE_TYPE_VIP = 2; // 积分类型 会员获取到
    public static final Integer ADD_SCORE_TYPE_PUBLISH = 3;  // 积分类型 发表文章
    public static final Integer ADD_SCORE_TYPE_READ = 4; // 积分类型 阅文章
    public static final Integer ADD_SCORE_TYPE_LIKER = 5; // 积分类型 阅文章
    public static final Integer ADD_SCORE_TYPE_REGIS = 5; // 积分类型 注册
    public static final Integer ADD_SCORE_BY_READ = 1;  // 阅读文章 阅读者加积分
    public static final Integer ADD_SCORE_BY_REGIS = 50; // 注册时初始化赠送积分
    public static final Integer SUB_SCORE_BY_PUBLISH = -100; // 发表文章 时积分状态
    public static final Integer ADD_SCORE_BY_ANON = 1; //通过匿名读者给分享者增加积分数
    public static final Integer ADD_SCORE_BY_REAL = 10; // 通过实名读者给分享者增加积分数 即带uid
    public static final Integer ADD_SCORE_BY_REAL_WX = 10; // 通过实名读者给分享者增加积分数 即带openid
